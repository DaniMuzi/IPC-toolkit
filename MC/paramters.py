...
# This function takes in input the parameters of the partilces are returns
...
# This function put the particles in one of the reference configurations, to be given in input by conf
...
# These functions switch representation between energy vectors: inverts the matrix W and compute epsilon
